...
import GlobeBackground from "@/components/3d/globe-background"
...
export function HeroGlobe() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-[#020408]">
      ...
      <div className="absolute inset-0 z-0 bg-linear-to-b from-transparent via-background/20 to-background/90 pointer-events-none" />
      ...
      <div className="container px-4 text-center z-10 relative">
        ...
        >
          <div className="inline-block rounded-full bg-secondary/10 border border-purple-500/30 px-4 py-1.5 text-sm font-medium text-purple-400 mb-6 backdrop-blur-md">
